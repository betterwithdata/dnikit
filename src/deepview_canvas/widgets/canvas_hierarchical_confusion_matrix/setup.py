...
name = 'canvas_hierarchical_confusion_matrix'
...
data_files_spec = [
    ('share/jupyter/nbextensions/canvas_hierarchical_confusion_matrix',
     'canvas_hierarchical_confusion_matrix/nbextension', '**'),
    ('share/jupyter/labextensions/canvas-hierarchical-confusion-matrix',
     'canvas_hierarchical_confusion_matrix/labextension', '**'),
    ('share/jupyter/labextensions/canvas-hierarchical-confusion-matrix',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'canvas_hierarchical_confusion_matrix.json'),
]
