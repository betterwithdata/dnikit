...
data_files_spec = [
    ('share/jupyter/nbextensions/canvas_markdown',
     'canvas_markdown/nbextension', '**'),
    ('share/jupyter/labextensions/canvas-markdown',
     'canvas_markdown/labextension', '**'),
    ('share/jupyter/labextensions/canvas-markdown',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'canvas_markdown.json'),
]
