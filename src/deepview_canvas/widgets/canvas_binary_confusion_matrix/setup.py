...
name = 'canvas_binary_confusion_matrix'
...
data_files_spec = [
    ('share/jupyter/nbextensions/canvas_binary_confusion_matrix',
     'canvas_binary_confusion_matrix/nbextension', '**'),
    ('share/jupyter/labextensions/canvas-binary-confusion-matrix',
     'canvas_binary_confusion_matrix/labextension', '**'),
    ('share/jupyter/labextensions/canvas-binary-confusion-matrix',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'canvas_binary_confusion_matrix.json'),
]
